...
ssize_t i2c_read(const I2CDevice *device, unsigned int iaddr, unsigned char *buf, size_t len);
...
typedef ssize_t (*I2C_READ_HANDLE)(const I2CDevice *dev, unsigned int iaddr, unsigned char *buf, size_t len);
typedef ssize_t (*I2C_WRITE_HANDLE)(const I2CDevice *dev, unsigned int iaddr, const unsigned char *buf, size_t len);
